  ...
  return (
    <section className="mt-20 sm:mt-24 lg:mt-28 mx-auto px-4 sm:px-6 lg:px-0">
      <div className="mx-auto text-center">
        <h1 className="text-[#FF5225] text-sm sm:text-base font-bold tracking-widest uppercase mb-4 lg:mb-5">
          {data.tag}
        </h1>

        <p className="text-xl sm:text-2xl lg:text-4xl font-semibold text-[#000000] mb-4 lg:mb-7 leading-tight max-w-sm sm:max-w-2xl lg:max-w-200 mx-auto px-2 sm:px-0">
          {data.title}
        </p>
