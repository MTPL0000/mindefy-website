      ...
      <div className="mx-auto text-center">
        ...
        <div className="w-[95%] md:w-[85%] lg:w-241 font-normal mx-auto mb-6 md:mb-9 text-justify space-y-4 md:space-y-7 px-2 md:px-0">
          <p className="text-sm md:text-base text-[#444444] leading-relaxed">
            ...
            workforce development services, we offer flexible resources to meet
            your specific needs. Explore our full-timе, part-timе, and
          ...
          <p className="text-sm md:text-base font-normal text-[#444444] leading-relaxed">
            Wе mееt your spеcific projеct rеquirеmеnts through flеxiblе rеsourcе
            modеls, including full-time, part-time and task-basеd contracts.
            Choose from on-site or off-site options to optimize collaboration
