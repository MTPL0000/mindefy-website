      ...
      <div className="mx-auto text-center">
        ...
        <div className="w-full max-w-[90%] sm:max-w-180 lg:w-241 font-normal mx-auto mb-9 text-justify space-y-5 px-4 lg:px-0">
          ...
          <p className="text-sm sm:text-base font-medium text-[#444444] leading-relaxed">
            Using our expertise in RAD models and agile development, we provide
            you with customized solutions that meet your unique business goals
            and deliver superior results. Our team of highly trained and
            experienced professionals specializes in rapid prototyping,
            iterative development and rapid feedback loops for continuous
            improvement and adaptability. With Mindefy as your trusted partner,
            you gain a competitive edge by delivering solutions that exceed
            expectations, reduce risk and optimize resource allocation.
            Experience the pinnacle of agile development and RAD model services
            with Mindefy to drive innovation, accelerate time to market and
            propel your business to unparalleled success in today's fiercely
