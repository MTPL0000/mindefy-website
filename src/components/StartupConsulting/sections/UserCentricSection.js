  ...
  return (
    <div className="w-full max-w-[90%] sm:max-w-[85%] md:max-w-[80%] lg:max-w-300 xl:w-290 mb-12 sm:mb-16 md:mb-20 mx-auto flex flex-col lg:flex-row items-center px-4 sm:px-6 lg:px-8 xl:px-0">
      <div className="w-full lg:w-191.5 mb-6 lg:mb-0">
        <div className="font-semibold text-2xl sm:text-3xl md:text-3xl text-[#000000] mb-4 sm:mb-5 text-center lg:text-left">
          <p>{data.title}</p>
        </div>
        <div className="font-normal text-sm sm:text-base text-[#444444] text-justify leading-relaxed">
