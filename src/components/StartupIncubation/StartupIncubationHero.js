    ...
    <section className="mt-28 mx-auto px-4 xl:px-0">
      <div className="mx-auto text-center">
        ...
        <div className="w-full max-w-245.5 font-normal mx-auto mb-9 text-justify space-y-5 px-4 xl:px-0">
          ...
          <p className="text-sm lg:text-base text-[#444444] leading-relaxed">
            Look no further! At Mindefy, we specialize in incubating innovative
            concepts and nurturing them into successful ventures. Our Startup
            Incubation Services are designed to empower individuals with ideas,
            guiding them through every step of the journey, from{" "}
            <span className="font-semibold">
