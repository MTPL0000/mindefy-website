        ...
        <div className="mx-auto flex flex-col gap-8 sm:gap-10 lg:gap-15">
          <div className="flex flex-col justify-between items-start gap-6">
            <div className="w-full flex flex-col lg:flex-row justify-between gap-6 lg:gap-0">
              <div>
                <h4 className="text-[#F690A1] text-lg sm:text-xl lg:text-3xl font-normal flex items-center gap-2">
                  <span className="w-6 sm:w-8" role="img" aria-label="pin">
                    📍
                  </span>{" "}
                  Preparation
                </h4>
                <p className="text-[#52B7B7] text-2xl sm:text-3xl lg:text-6xl font-bold mt-1 uppercase">
                  USER RESEARCH
                </p>
              </div>
              <div>
            ...
            <p className="text-[#2B7575] text-base sm:text-lg lg:text-xl font-normal mt-4 leading-relaxed">
              ...
              their frustrations and their struggle to get their understanding.
              I have two used methods which contributed hugely in addition to my
              own findings
            </p>
          </div>
          <div>
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {[1, 2, 3, 4].map((num) => (
              <div key={num} className="relative">
                <Image
                  src={`/images/projects/EFS-${num}.png`}
                  alt="image"
                  width={566}
                  height={370}
        ...
        <div className="mx-auto flex flex-col gap-8 sm:gap-12">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
            {interviewCards.map((item, idx) => (
              ...
              >
                <div className="absolute top-4 sm:top-6 right-6 sm:right-9 text-[#E9F6F6] text-8xl md:text-9xl leading-none font-serif select-none">
                  &rdquo;
                </div>
        ...
        <div className="relative w-full overflow-hidden mb-12 bg-[#E9F6F6] md:shadow-[0_35px_44px_0_rgba(30,66,66,0.05)] md:border-b md:border-[#E9F6F6] md:rounded-bl-[50%_100%] md:rounded-br-[50%_100%]">
          <div className="relative flex flex-col gap-2 items-center pt-12 sm:pt-16 pb-16 sm:pb-24">
            ...
            <p className="text-[#377D7D] text-sm sm:text-base font-normal text-center w-full md:w-150 lg:w-188 px-4">
              It embodies the characteristics, goals, motivations, and behaviors
              of real users, serving as a reference point for design and
              decision-making processes in UX/UI development
            </p>
          </div>
        </div>
        <div className="max-w-300 mx-auto mt-6 sm:mt-10 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-start px-4 sm:px-6">
          <div className="mt-6 sm:mt-12">
            ...
            <p className="w-full max-w-2xl text-[#377D7D] font-normal text-justify text-sm sm:text-base lg:text-lg mt-2 leading-relaxed">
              ...
              family was neither too open but mother has been always supportive
              and because of her I have achieved a lot of things in my life. I
              have done graduation and a diploma in hospitality. I have learned
              a lot from my career as I used to keep changing my jobs. I started
              my own business as well in Gurgaon. My business was my achievement
              I was so proud of and now being a mother is my another achievement
              as I love this phase of my life. I have a small and beautiful
              family of a baby boy, my dog, and my husband. I love doing DIY
              projects, painting, and traveling. Thanks
            </p>
          </div>
