  ...
  return (
    <>
      ...
      <div className="m-auto w-full max-w-175 px-4 sm:px-6 flex flex-col items-center justify-center gap-2">
        ...
        <h3 className="text-[#52B7B7] text-2xl sm:text-3xl lg:text-4xl font-semibold text-center">
          About This Project
        </h3>
      ...
      <div className="max-w-286 mx-auto px-4 sm:px-6 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-15">
        <div className="w-full lg:w-[60%] flex flex-col items-start justify-center gap-4 lg:gap-5">
          ...
          <h2 className="text-[#52B7B7] text-2xl sm:text-3xl lg:text-4xl font-semibold leading-tight">
            Overview
          </h2>
          <p className="text-[#2B7575] text-base sm:text-lg font-normal text-justify leading-relaxed">
            ...
            options for her own baby, she found her purpose: to re-introduce the
            traditional Indian foods for people. EarlyFoods is a very successful
            E-Commerce Store for buying healthy snacks for expecting mothers,
            breast-feeding mothers, infants and children who are beginning to
            develop their taste buds and also building their body.
          </p>
      ...
      <div className="max-w-286 mx-auto px-4 sm:px-6 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-15 mt-5">
        <div className="w-full lg:w-[60%] flex flex-col items-start justify-center gap-4 lg:gap-5">
          <h2 className="text-[#52B7B7] text-2xl sm:text-3xl lg:text-4xl font-semibold leading-tight uppercase">
            The STORY
          </h2>
          <div className="bg-[#BBE5E5] w-full h-0.5 leading-relaxed"></div>
          <p className="text-[#2B7575] text-base sm:text-lg font-normal text-justify leading-relaxed">
            We kicked off the discussion by asking how we can get folks to check
            out more of our products and make their journey with us super easy
            and enjoyable. As we kept talking, we also wondered how we could
            build trust, especially for first-time visitors to our WebApp.
          </p>
          <p className="text-[#2B7575] text-base sm:text-lg font-normal text-justify leading-relaxed">
            Think about Instagram—some people are a bit wary about buying stuff
            online because of bad experiences on other platforms. It gets even
            trickier when it's about health, especially for themselves and their
            kids. So, we need to figure out how to make them feel comfy and
            trust us right from the start.
          </p>
        </div>
        <div className="relative aspect-[1.3/1] w-full lg:w-[80%] max-w-[400px] lg:max-w-none">
          <Image
            src="/images/projects/EF-3.webp"
            alt="EarlyFoods circular visual"
            fill
            className="object-contain"
            loading="lazy"
