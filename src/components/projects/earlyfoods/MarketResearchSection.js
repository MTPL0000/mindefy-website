      ...
      <div className="w-full mx-auto px-6 bg-[#E9F6F6] relative overflow-hidden">
        <div className="mx-auto pt-16">
          <div className="relative w-full overflow-hidden mb-12 bg-[#E9F6F6] md:shadow-[0_35px_44px_0_rgba(30,66,66,0.05)] md:border-b md:border-[#E9F6F6] md:rounded-bl-[50%_100%] md:rounded-br-[50%_100%]">
            <div className="relative flex flex-col gap-2 items-center pb-24">
              ...
              <p className="text-[#377D7D] leading-relaxed text-base font-normal text-center w-full md:w-150 lg:w-188">
                ...
                information about a market, including a product's or service's
                nature, characteristics, and potential customer base.
              </p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-242 mx-auto mb-15">
            <p className="text-[#2B7575] text-xl font-medium leading-relaxed text-justify">
              These findings indicate that there is a strong market for organic
              and healthier pre-prepared and ready-to-eat meals and snacks among
              parents and new mothers. It is likely that such a product would be
              successful in the market if it is backed by trusted sources,
              offers convenience and reduces stress (such as reductions in
              cost), and offers
            </p>
          </div>
        </div>
      ...
      <div className="w-full mx-auto mb-30 px-6 bg-[#E9F6F6] relative overflow-hidden">
        <div className="relative w-full overflow-hidden mb-12 bg-[#E9F6F6] md:shadow-[0_35px_44px_0_rgba(30,66,66,0.05)] md:border-b md:border-[#E9F6F6] md:rounded-bl-[50%_100%] md:rounded-br-[50%_100%]">
          <div className="relative flex flex-col gap-2 items-center pt- pb-24">
            ...
            <p className="text-[#377D7D] leading-relaxed text-base font-normal text-center w-full md:w-150 lg:w-188">
              Based on the problems we found out below are the solutions that we
              proposed client in order to enhance the overall User experience
              and enhance the joy of shopping from the Early Foods.
            </p>
          </div>
        </div>
