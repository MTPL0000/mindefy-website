...
export default function ImprovedCopyPage() {
    ...
    const handleSectionTransition = useCallback((direction, fromSection) => {
        ...
        const transitions = {
            ...
            2: { up: 1, down: 3 }, // Cards ↔ Image/CaseStudies
            3: { up: 2 } // CaseStudies → Cards
        };
    ...
    const triggerZoomAnimation = useCallback(async () => {
        ...
        // Use Framer Motion for smooth zoom
        ...
        }, 6 * 0.1 * 1000 + 0.5 * 1000 + 500); // Total animation time + buffer
    }, [currentSection, sectionState.hasInteracted, zoomControls, cardControls]);
