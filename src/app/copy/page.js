    ...
    >
          ...
          <div className="grid grid-cols-3 gap-6 max-w-6xl">
            {cardData.map((card, index) => (
              ...
              >
                ...
                <h3 className="text-base font-semibold text-[#FF5225] mb-1">
                  {card.title}
                </h3>
      ...
      >
        ...
        {!sectionState.section5HasStarted ? (
          ...
          /* Final layout with heading at top */
          <motion.div
            ...
            <div className="flex-1 flex items-center justify-center">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0 max-w-6xl mx-auto w-full">
                ...
                <motion.div
                  initial={{ opacity: 0, y: 100 }}
                  animate={
                    currentSection === 5 && sectionState.section5HasStarted
                      ? {
                          opacity: 1,
                          y: 0,
                          transition: {
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-[#E53E3E] mb-6 text-left leading-relaxed">
                      Build Intelligent Systems That Learn, Adapt, And Automate
                      Complex Decisions — From GenAI To NLP And Computer Vision.
                    </p>
                  </div>
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-[#E53E3E] mb-6 text-left leading-relaxed">
                      Design, Train, And Deploy Models That Predict, Classify,
                      And Optimize — Using Structured And Unstructured Data.
                    </p>
                  </div>
                  <button className="flex items-center text-left text-sm font-medium text-[#262626] hover:text-[#4A5568] transition-colors">
                    Learn More <span className="ml-2">→</span>
                ...
                <motion.div
                  ...
                  animate={
                    currentSection === 5 &&
                    sectionState.section5ScrollProgress >= 0.5
                      ? {
                          opacity: 1,
                          y: 0,
                          transition: {
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-[#E53E3E] mb-6 text-left leading-relaxed">
                      Transform Raw Data Into A Strategic Asset — We Build
                      Reliable Pipelines, Scalable Data Lakes, And Intelligent
                      Warehouses That Power Insightful Dashboards, Business
                      Intelligence, And Advanced Analytics. From Data Collection
                      To Decision-Making, We Engineer The Entire Journey.
                    </p>
                  </div>
                  <button className="flex items-center text-left text-sm font-medium text-[#262626] hover:text-[#4A5568] transition-colors">
                    Learn More <span className="ml-2">→</span>
                ...
                <motion.div
                  ...
                  animate={
                    currentSection === 5 &&
                    sectionState.section5ScrollProgress >= 0.75
                      ? {
                          opacity: 1,
                          y: 0,
                          transition: {
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-[#E53E3E] mb-6 text-left leading-relaxed">
                      Build And Scale With The Power Of The Cloud. We Design
                      Secure, High-Performance Cloud Infrastructures That
                      Support AI, Data, And Modern Applications—Ensuring Speed,
                      Flexibility, And Resilience Across AWS, Azure, And GCP.
                    </p>
                  </div>
                  <button className="flex items-center text-left text-sm font-medium text-[#262626] hover:text-[#4A5568] transition-colors">
                    Learn More <span className="ml-2">→</span>
