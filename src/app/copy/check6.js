    ...
    return (
        <div ref={containerRef} className="relative h-screen w-screen overflow-hidden">
            ...
            <motion.div 
                ...
                transition={{ duration: 0.8 }}
            >
                {/* Step 1: Heading appears centered */}
                <motion.div
                    className="absolute inset-0 flex items-center justify-center z-10"
                    initial={{ opacity: 0 }}
                    animate={currentSection === 5 ? {
                        opacity: [0, 1, 1, 0],
                        transition: { 
                            duration: 3,
                            times: [0, 0.2, 0.7, 1],
                ...
                {/* Step 2: Final layout with heading at top and cards */}
                <motion.div
                    className="h-screen flex flex-col px-8 lg:px-16 py-16"
                    initial={{ opacity: 0 }}
                    animate={currentSection === 5 ? {
                        opacity: 1,
