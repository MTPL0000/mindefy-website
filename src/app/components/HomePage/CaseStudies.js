        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-lg overflow-hidden">
            <div className="flex flex-col h-full">
              ...
              <div className="p-6 flex flex-col flex-grow">
                <h3 className="text-xl md:text-2xl font-bold text-[#2B2B2B] mb-2">Gen AI-Chatbot</h3>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl shadow-lg overflow-hidden">
            <div className="flex flex-col h-full">
              ...
              <div className="p-6 flex flex-col flex-grow">
                <h3 className="text-xl md:text-2xl font-bold text-[#2B2B2B] mb-2">ML Driven Recommendations</h3>
                <p className="text-sm md:text-base text-gray-600 mb-6 flex-grow">
