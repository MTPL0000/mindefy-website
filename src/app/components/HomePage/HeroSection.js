...
export default function HeroSection() {
  // Client logos data
  const clientLogos = [
    { src: "/images/Kotak.svg", alt: "Kotak", aspectRatio: "2.39/1" },
    { src: "/images/netlink.svg", alt: "Netlink", aspectRatio: "2.39/1" },
    { src: "/images/krungthai.svg", alt: "Krungthai", aspectRatio: "2.39/1" },
    { src: "/images/mst.svg", alt: "MST", aspectRatio: "7/6" },
    { src: "/images/Bottomline.svg", alt: "Bottomline", aspectRatio: "2.39/1" },
    { src: "/images/solistack.png", alt: "Solistack", aspectRatio: "2.39/1" },
    { src: "/images/jego-icon.svg", alt: "Jego-Mindefy", aspectRatio: "1/1" },
  ];
              ...
              {clientLogos.map((logo, index) => (
                <div 
                  ...
                  className={`flex-shrink-0 mx-4 sm:mx-6 lg:mx-8 ${
                    logo.alt === "MST"
                      ? "w-12 sm:w-16 lg:w-20" : logo.alt === "Jego-Mindefy"
