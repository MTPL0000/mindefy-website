    ...
    <div className="min-h-screen bg-[#E9F6F6]">
      <div className="max-w-screen mx-auto flex flex-col lg:flex-row">
        ...
        <div className="flex-1 min-w-0 pt-10">
          ...
          <section
            id="introduction"
            className="mb-12 sm:mb-16 md:mb-20 lg:mb-24 p-4 sm:px-6 lg:px-8 mt-6 sm:mt-8 lg:mt-10"
          >
          ...
          <section id="technical-implementation" className="mb-12 sm:mb-16 md:mb-20 lg:mb-24 p-4 sm:px-6 md:px-8">
          ...
          <section id="technology-stack" className="mb-12 sm:mb-16 md:mb-20 lg:mb-24 p-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
