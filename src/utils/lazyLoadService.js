...
export const LazyDigitalTransformation = createLazyServiceComponent(
...
export const LazyEnterpriseSolutions = createLazyServiceComponent(
  "EnterpriseSolutions"
);
export const LazyStartupConsulting =
  createLazyServiceComponent("StartupConsulting");
export const LazyStartupIncubationConsulting = createLazyServiceComponent(
...
export const LazyYourHour = createLazyServiceComponent("products/YourHour/index");
...
export const LazyMemolect = createLazyServiceComponent("projects/Memolect/index");
